...
CREATE TABLE `jyxw` (
  ...
  `XGSJ` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`,`JJZDM`,`QSname`)
) ENGINE=InnoDB AUTO_INCREMENT=1040 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
